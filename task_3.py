...
class Cells:
    def __init__(self, cell):
        self.cell = cell
        print('Создана клетка размером: ', self.cell)
    ...
    def __sub__(self, other):
        if self.cell - other.cell > 0:
            ...
            return 'вычитание невозможно, клетка ликвидируется'
    ...
    def __truediv__(self, other):
        if self.cell - other.cell > 0:
            ...
            return 'деление невозможно, клетка ликвидируется'

    def make_order(self, part):
        result = ''
        for i in range(0, (self.cell // part)):
            result += '*'*part + '\n'
        result += '*'*(self.cell % part) + '\n'
        return result
...
print('Сложение клеток: ', cell1 + cell2)
